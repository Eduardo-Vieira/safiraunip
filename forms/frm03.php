...
<input type="hidden" value="39" id="idpergunta" name="idpergunta">
<input type="hidden" value="3" id="idformulario" name="idformulario">
<input type="hidden" value="9" id="iddefull" name="iddefull">

<div class="container">
  <div class="row">
    <div class="page-header">
        <p><b>03 - QUESTIONÁRIO DE AVALIAÇÃO INSTITUCIONAL INTERNA DESTINADO AO CORPO DOCENTE - 2015</b></p>
    </div>
  </div>
      <div>
    ...
    <div class="panel panel-default" id="1">
          <div class="panel-heading">1. A avaliação institucional interna da UNIP torna-se importante quando contribui com a qualidade da formação oferecida ao aluno e quando indica fragilidades para as quais são indicadas e executadas ações corretivas.</div>
    ...
    <div class="panel panel-default" id="2">
          <div class="panel-heading">2. A Missão Institucional da UNIP apresenta clareza, objetividade e coerência entre seus elementos e a realidade institucional, facilitando e viabilizando seu cumprimento.</div>
          <div class="panel-body">
    ...
    <div class="panel panel-default" id="3">
          <div class="panel-heading">3. Os recursos didático pedagógicos oferecidos pela UNIP atende às necessidades dos planos pedagógicos e contribui para a apresentação dos conteúdos e qualidade da aprendizagem.</div>
          <div class="panel-body">
    ...
    <div class="panel panel-default" id="4">
          ...
          <div class="panel-body">
                ...
                <ul class="pager">
                  ...
                  <li class="next"><a href="#" onclick="divn('5','1')" id="next4">Próximo  <span aria-hidden="true">&rarr;</span></a></li>
                </ul>
              </nav>
     			 </div>
          </div>
    ...
    <div class="panel panel-default" id="5">
          <div class="panel-heading">5. O Plano de Desenvolvimento Institucional – PDI da UNIP é um documento elaborado para nortear as ações e políticas da instituição e é disponibilizado para conhecimento dos docentes, coordenadores e tutores.</div>
          <div class="panel-body">
    ...
    <div class="panel panel-default" id="6">
          <div class="panel-heading">6. A UNIP desenvolve atividades de Extensão Comunitária com o objetivo de contribuir para o desenvolvimento local, regional e nacional, por meio de eventos culturais, artísticos e sociais.</div>
          <div class="panel-body">
                 ...
                 <div class="form-group">
      				<nav>
                <ul class="pager">
                  <li class="previous"><a href="#" onclick="divn('5','1')" id="previous6">Anterior<span aria-hidden="true">&larr;</span> </a></li>
    ...
    <div class="panel panel-default" id="7">
          <div class="panel-heading">7. A contribuição da melhoria regional e a responsabilidade social estão claras nas ações da UNIP.</div>
          <div class="panel-body">
                ...
                <ul class="pager">
                  ...
                  <li class="next"><a href="#" onclick="divn('8','2')" id="next7">Próximo  <span aria-hidden="true">&rarr;</span></a></li>
                </ul>
              </nav>
     			 </div>
          </div>
    ...
    <div class="panel panel-default" id="8">
          <div class="panel-heading">8. A UNIP desenvolve ações de ensino, pesquisa e extensão que contribuem para a melhoria da qualidade de vida da sociedade local.</div>
          <div class="panel-body">
    ...
    <div class="panel panel-default" id="9">
          <div class="panel-heading">9. A UNIP mantém uma política de apoio aos coordenadores e professores que possibilita o desenvolvimento de um trabalho pedagógico integrado e de qualidade, com a utilização das ferramentas disponibilizadas tanto presencial quanto virtualmente.</div>
          <div class="panel-body">
                 ...
                 <div class="form-group">
      				<nav>
                <ul class="pager">
                  <li class="previous"><a href="#" onclick="divn('8','2')" id="previous9">Anterior<span aria-hidden="true">&larr;</span> </a></li>
    ...
    <div class="panel panel-default" id="10">
          <div class="panel-heading">10. Os objetivos da UNIP e suas ações, por meio de suas políticas, atende às necessidades da comunidade acadêmica e da sociedade civil.</div>
          <div class="panel-body">
                ...
                <ul class="pager">
                  ...
                  <li class="next"><a href="#" onclick="divn('11','3')" id="next10">Próximo  <span aria-hidden="true">&rarr;</span></a></li>
                </ul>
              </nav>
     			 </div>
          </div>
    ...
    <div class="panel panel-default" id="11">
          <div class="panel-heading">11. O pessoal de apoio técnico administrativo aos docentes e coordenadores de curso da UNIP é suficiente e bem preparado.</div>
          <div class="panel-body">
    ...
    <div class="panel panel-default" id="12">
          <div class="panel-heading">12. A política de carreira e a capacitação docente, considerando a remuneração, o regime de trabalho e o estímulo à ascensão na carreira, são considerados pontos fortes da UNIP.</div>
          <div class="panel-body">
                 ...
                 <div class="form-group">
      				<nav>
                <ul class="pager">
                  <li class="previous"><a href="#" onclick="divn('11','3')" id="previous12">Anterior<span aria-hidden="true">&larr;</span> </a></li>
       ...
       <div class="panel panel-default" id="13">
          <div class="panel-heading">13. Os recursos do ambiente virtual, o acervo nas bibliotecas e todo o material didático-pedagógico disponibilizado para os alunos atendem às suas necessidades e garantem um trabalho de qualidade.</div>
          <div class="panel-body">
                ...
                <ul class="pager">
                  ...
                  <li class="next"><a href="#" onclick="divn('14','4')" id="next14">Próximo  <span aria-hidden="true">&rarr;</span></a></li>
               </ul>
              </nav>
     			 </div>
          </div>
          ...
          <div class="panel-heading">14. A infraestrutura disponibilizada para os docentes tem como objetivo garantir que estes desenvolvam suas atividades acadêmicas de forma eficiente e eficaz.</div>
          <div class="panel-body">
              ...
              <nav>
                <ul class="pager">
                  ...
                  <li class="next"><a href="#" onclick="divn('15','5')" id="next15">Próximo  <span aria-hidden="true">&rarr;</span></a></li>
                </ul>
              </nav>
           </div>
          </div>
          ...
          <div class="panel-heading">15. A infraestrutura do campus da UNIP é adequada para o atendimento às necessidades dos alunos em todos os aspectos (físicos e pedagógicos).</div>
          <div class="panel-body">
              ...
              <nav>
                <ul class="pager">
                  <li class="previous"><a href="#" onclick="divn('14','4')" id="previous15">Anterior<span aria-hidden="true">&larr;</span> </a></li>
                <div align="right">
